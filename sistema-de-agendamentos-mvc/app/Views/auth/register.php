...
<div class="min-h-screen flex items-center justify-center p-4 bg-slate-100">
  <div class="w-full max-w-md">
    ...
    <div class="text-center mb-8">
      ...
      <p class="text-slate-500 text-sm mt-1">Criar nova conta</p>
    </div>
    ...
    <div class="bg-white rounded-xl border border-slate-200 shadow-sm p-8">
      <h2 class="text-lg font-bold text-slate-800 mb-6">Criar conta</h2>
      <form method="POST" action="/register" class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">Senha <span class="text-slate-400 font-normal">(mín. 6 caracteres)</span></label>
    ...
    <p class="text-center text-sm text-slate-500 mt-4">
      Já tem conta? <a href="/login" class="text-blue-600 font-semibold hover:underline">Entrar</a>
    </p>
